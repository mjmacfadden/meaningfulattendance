...
var data = [
    ...
    ["2/1", "What is your favorite type of font?", "-Violet"],
    ["2/2", "If you could choose a kind of store that is not a clothing store to look around in, what kind would it be?", "-Skylar"],
    ...
    ["2/5", "What animal most represents your personality?", "-Mrs. M."],
    ["2/6", "Would you rather be freezing cold or super hot?"],
    ["2/7", "Are you a cake or cookie person?", "-Skylar"],
    ["2/8", "Are you more of an optimist or a pessimist?", "-Violet"],
    ["2/9", "If you were principal for the day, what would you do?", "-Evie"],
    ...
    ["2/12", "How do you eat an Oreo?", "-Mrs. M"],
    ["2/13", "If you could possess any superpower, what would it be and how would you use it?"],
    ["2/14", "Would you rather eat a footlong slug or a big toad?", "-Kevin"],
    ["2/15", "Do you have any favorite quotes or sayings that resonate with you?"],
    ["2/16", "If you could be anything besides a human, what would you be?", "-Layth"],
    ["2/17", "If you opened a bakery, what is one item you would sell?", "-Joaquin"],
    ...
    ["2/20", "If you could pick one song to be your walkup song, what would it be? Why?", "Allie & Lyla"],
